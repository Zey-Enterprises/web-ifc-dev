...
This distinction is useful because emotions often contain information, but that information needs interpretation. A feeling may point to hunger, fatigue, threat, grief, injustice, shame, desire, or an old pattern being activated. {% include glossary.html id="mindfulness" text="Mindfulness" %} helps by creating enough space to observe the feeling before turning it into action.{% include citation.html id="bishop-2004-mindfulness" label="1" %}

Objectivist epistemology treats emotions as consequences of underlying judgments and premises, not as tools of cognition by themselves.{% include citation.html id="peikoff-1991-objectivism-philosophy-of-ayn-rand" label="2" %} Practically, ask yourself "What am I feeling?", "What stimulus triggered my reaction?", "What value judgments am I automatically attaching to that stimulus?", "What do I think my emotion means?", "What facts support that interpretation?", "What else could be true?", among other such questions.
