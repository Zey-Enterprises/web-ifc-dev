...
resource_type: faq
redirect_to: "/resources/faq/#how-can-i-support-someone-else-s-goals-without-trying-to-control-them"
sitemap: false
domains:
  - psychology
concerns:
...
Support means helping someone pursue their own {% include glossary.html id="values" %}. Control means trying to make their choices, priorities, emotions, or outcomes conform to yours.
