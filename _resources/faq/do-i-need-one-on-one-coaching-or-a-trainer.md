...
resource_type: faq
redirect_to: "/resources/faq/#do-i-need-one-on-one-coaching-or-a-trainer"
sitemap: false
domains:
  - physical-exercise
  - psychology
...
A useful question is whether your current approach is actually working. Are you learning, growing, recovering, becoming more capable, and moving toward your {% include glossary.html id="values" %}? Or do you keep restarting, spinning in confusion, avoiding difficult truths, rationalizing, overcomplicating things, or repeating the same problems without understanding why? Outside guidance is often most valuable when self-direction keeps breaking down, despite sincere effort.
