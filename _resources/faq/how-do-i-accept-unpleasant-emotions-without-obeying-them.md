...
header:
  actions:
    - label: "← See in FAQ Library"
      url: /resources/faq/#how-do-i-accept-unpleasant-emotions-without-obeying-them
      class: btn--primary
domains:
  - psychology
  - philosophy
...
citations:
  ...
  - label: "2"
    id: brackett-2019-permission-to-feel
  - label: "3"
...
The skill is staying in contact with the feeling while still choosing your action. You can feel afraid and tell the truth. You can feel ashamed and repair. You can feel angry and set a clean {% include glossary.html id="boundary" %}. You can feel sad and still eat, sleep, train, work, or ask for support.
