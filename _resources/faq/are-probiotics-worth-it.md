...
For most healthy people, the first layer is still food: enough {% include glossary.html id="fiber" %}, diverse plant foods, and fermented foods such as yogurt with live cultures, kefir, sauerkraut, kimchi, fermented pickles, miso, tempeh, natto, and kombucha. These foods are usually better starting points than probiotic pills because they come packaged with nutrients, acids, fibers, polyphenols, and other food-matrix effects that can support the gut {% include glossary.html id="microbiome" %}, rather than delivering isolated organisms with uncertain survival and uncertain relevance to your specific problem.
