---
title: "Does a good life require one central purpose?"
date: 2026-04-25
...
A {% include glossary.html id="central-purpose" text="central purpose" %} is not just a hobby, career ambition, or productivity system. It is the major productive aim that gives long-range structure to a life. In Objectivism, productive work is the central purpose of a rational life: the central value that integrates and helps order the rest of one's {% include glossary.html id="value-hierarchy" text="hierarchy of values" %}.{% include citation.html id="rand-1964-virtue-of-selfishness" label="1" %}<span class="ifc-citation-marker" aria-hidden="true">,</span>{% include citation.html id="peikoff-1991-objectivism-philosophy-of-ayn-rand" label="2" %}
...
This also does not mean everyone needs a grand public mission. Productive work can be great or modest, intellectual or physical, entrepreneurial or domestic, artistic or technical, paid or partly unpaid. The issue is not social prestige. The issue is whether you are using your mind to create, maintain, improve, or build real {% include glossary.html id="values" text="values" %} in a sustained way.
