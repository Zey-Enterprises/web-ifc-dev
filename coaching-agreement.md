...
* physical exercise programming and training guidance  
* nutrition education and dietary structuring  
* habit formation and behavioral change strategies  
* lifestyle optimization (sleep, stress, recovery)  
* progress monitoring and feedback  
* analytical/philosophical discussion, Socratic dialogue, conceptual analysis, problem-solving, and reflective inquiry on reasoning, beliefs, and values
...
Unless otherwise agreed in writing or provided for in the Coaching Package Addendum, all synchronous Services are conducted via voice or video call (as mutually agreed between Client and Coach).
...
* Zelle: [arthur@deltawerx.com](mailto:arthur@deltawerx.com)  
* physical check
...
Monthly services may be discontinued at any time and require 15 days' advance notice in writing before the next renewal date.
...
This Agreement will conclude when all monthly services have been cancelled, all fixed-price Services have been provided, and when no new Pay-as-You-Go Services have been used for a period of 90 days.
...
The Client may reschedule or cancel a scheduled session without penalty by providing at least 24 hours' notice via email or another mutually agreed-upon communication method. If less than 24 hours' notice is given

* for Pay-as-You-Go Services, a $50 cancellation fee will be charged;  
* for fixed-price or monthly Services that include scheduled time (ie, voice or video calls), the missed session will be forfeited and deducted from the total time allowance, or Client may elect to pay a $50 cancellation fee.
...
Client is advised to seek out a doctor, psychotherapist, psychiatrist, physical therapist, registered dietician or nutritionist, or other qualified medical professional for purposes of diagnosis and treatment of any condition or injury. The Coach's observations or advice is not intended as a substitute for these services.
